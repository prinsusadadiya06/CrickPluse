...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const [matchesRes, newsRes, videosRes] = await Promise.all([
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden flex flex-col md:pb-0 pb-[50px] bg-gray-100 md:bg-gray-50">
      ...
      {loading ? (
        ...
        <>
          <section className="md:py-6 py-3 px-4 sm:px-6 max-w-7xl mx-auto relative overflow-hidden w-full">
            ...
            <div className="w-full overflow-hidden relative">
              <div
                ref={sliderRef}
                className="flex gap-6 overflow-x-auto scroll-smooth no-scrollbar pb-4 pr-[835px] md:pr-10 w-full"
              ...
              >
                ...
                <div className="flex-shrink-0 w-[10vw] md:hidden"></div>
              </div>
            </div>
          </section>
